...
const ParallaxBackground = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none">
      ...
      >
        <div
          className="relative left-[calc(50%-11rem)] aspect-[900/500] w-[45rem] -translate-x-1/2 rotate-[10deg] 
               bg-gradient-to-tr from-pink-500 via-red-400 to-yellow-500 
               opacity-10 sm:left-[calc(50%-30rem)] sm:w-[60rem]"
          style={{
            clipPath:
